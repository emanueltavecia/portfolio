...
export function Header() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-[70] border-b border-blue-200/40 bg-slate-100/80 backdrop-blur-md dark:border-blue-950/30 dark:bg-gray-950/80">
